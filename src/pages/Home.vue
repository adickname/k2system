<script setup>
import OffertHome from "@/components/OffertHome.vue";
...
<template>
  <template v-if="isMobile">
    <div class="min-h-screen w-full flex flex-col items-center">
      ...
      <section>
        <h1 class="animate-expand-text text-center">
        ...
        <ImageBorder class="animate-coming-left">
          ...
          <img
            ...
            alt=""
        /></ImageBorder>
        <h2 class="animate-expand-text text-center">Konica Minolta Bizhub</h2>
        ...
        <h3 class="animate-expand-text text-center">
